...
@catalogo_bp.get("/")
def index():
    return render_template("steck/index.html")
...
def search():
    ...
    return render_template("steck/results.html", q=q, results=results,
...
def cart():
    return render_template("steck/cart.html", cart=get_cart())
...
def import_page():
    return render_template("steck/import.html")
...
def review_page():
    ...
    return render_template("steck/review.html", found=found, not_found=not_found)
